...
If you did it correctly, you can start your measurements and then read them by displaying all events on the terminal.\hypertarget{autotoc_md1_autotoc_md2}{}\section{Sensors}\label{autotoc_md1_autotoc_md2}
